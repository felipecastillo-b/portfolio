        ...
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    <h2 className="headline-2 lg:max-2-[12ch]">
                        Contáctame para colaborar
                    </h2>
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-2-[30ch]">
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(( { href, icon }, key) => (
                            <a 
                                ...
                                href={href}
                                target="_blank"
                                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-colot,colot] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
                            >
                                {icon}
                            </a>
                        ))}
                ...
                <form action="https://getform.io/f/bllldpgb" method="POST" className="xl:pl-10 2xl:pl-20">

                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            <label htmlFor="name" className="label">Nombre</label>
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Felipe Castillo" className="text-field" />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="email" className="label">Email</label>
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="felipe@example.com" className="text-field" />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="message" className="">Mensaje</label>
                            <textarea name="message" id="message" placeholder="Hola!" required className="text-field resize-y min-h-32 max-h-80"></textarea>
                        </div>
